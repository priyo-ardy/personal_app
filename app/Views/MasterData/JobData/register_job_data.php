                            ...
                            <div class="card-body rounded-0">
                                <div class="row g-2">
                                    <div class="form-group col-xl-3 col-lg-3 col-md-6 col-sm-12 clearfix">
                                        ...
                                        <select name="data_employee" id="data_employee" class="form-select select2 select2bs5" required>
                                    ...
                                    <div class="form-group col-xl-3 col-lg-3 col-md-6 col-sm-12 clearfix">
                                        ...
                                        <select name="data_relasi" id="data_relasi" class="form-select select2 select2bs5" required>
                                            <option value="">-- Choose --</option>
                                    ...
                                    <div class="form-group col-xl-3 col-lg-3 col-md-6 col-sm-12 clearfix">
                                        ...
                                        <input type="text" name="data_contract" id="data_contract" class="form-control rounded-0" required maxlength="50" autocomplete="off" placeholder="PKWT No./PKWTT No.">
                                        <div class="invalid-feedback"></div>
                                    </div>
                                    <div class="form-group col-xl-3 col-lg-3 col-md-6 col-sm-12 clearfix">
