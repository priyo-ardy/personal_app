                ...
                <div class="row g-2 mb-3">
                    <div class="col-12 clearfix">
                        <div class="card rounded-0">
                            <div class="card-header rounded-0 bg-primary text-white fw-bolder">
                                <h5 class="card-title">Employee Basic Information</h5>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-xl-9 col-lg-9 col-md-12 col-sm-12">
                                        <div class="row g-2">
                                            ...
                                            <div class="form-group col-xl-6 col-lg-6 col-md-6 col-sm-12 clearfix">
                                                ...
                                                <input type="text" name="data_name" id="data_name" class="form-control rounded-0" required placeholder="Employee Name" maxlength="150" autocomplete="off">
                                                <div class="invalid-feedback"></div>
                                            </div>
                                            <div class="form-group col-xl-4 col-lg-4 col-md-6 col-sm-12 clearfix">
                                                ...
                                                <input type="text" name="data_ktp" id="data_ktp" class="form-control rounded-0" required placeholder="Employee Name" maxlength="20" autocomplete="off">
                                                <div class="invalid-feedback"></div>
                                            </div>
                                            <div class="form-group col-xl-2 col-lg-2 col-md-6 col-sm-12 clearfix">
                                            ...
                                            <div class="form-group col-xl-2 col-lg-2 col-md-6 col-sm-12 clearfix">
                                                <label class="form-label" for="data_agama">Religion</label>
                                                <select name="data_agama" id="data_agama" class="form-control select2 select2bs5">
                                                    <option value="">-- Choose --</option>
                                            ...
                                            <div class="form-group col-xl-2 col-lg-2 col-md-6 col-sm-12 clearfix">
                                                ...
                                                <input type="number" name="data_tlp_1" id="data_tlp_1" class="form-control rounded-0" required placeholder="Primary Phone No." autocomplete="off">
                                                <div class="invalid-feedback"></div>
                                            </div>
                                            <div class="form-group col-xl-2 col-lg-2 col-md-6 col-sm-12 clearfix">
                                                <label class="form-label" for="data_tlp_3">Secondary Phone No.</label>
                                                <input type="number" name="data_tlp_2" id="data_tlp_2" class="form-control rounded-0" placeholder="Secondary Phone No." autocomplete="off">
                                            </div>
                                            <div class="form-group col-xl-2 col-lg-2 col-md-6 col-sm-12 clearfix">
                            ...
                            <div class="card-body">
                                <div class="row g-2">
                                    <div class="form-group col-xl-4 col-lg-4 col-md-12 col-sm-12 clearfix">
                                        ...
                                        <input type="text" name="data_nama_emergency" id="data_nama_emergency" class="form-control rounded-0" required placeholder="Emergency Contact Name" autocomplete="off" maxlength="150">
                                        <div class="invalid-feedback"></div>
                                    </div>
                                    <div class="form-group col-xl-4 col-lg-4 col-md-12 col-sm-12 clearfix">
                                    ...
                                    <div class="form-group col-xl-4 col-lg-4 col-md-12 col-sm-12 clearfix">
                                        ...
                                        <input type="number" name="data_tlp_emergency" id="data_tlp_emergency" class="form-control rounded-0" required placeholder="Emergency Contact Phone No." autocomplete="off">
                                        <div class="invalid-feedback"></div>
                                    </div>
                    ...
                    <div class="col-12 clearfix">
                        <div class="card rounded-0">
                            <div class="card-header bg-primary text-white fw-bolder rounded-0">
