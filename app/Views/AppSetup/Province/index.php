                    ...
                    <div class="card rounded-0">
                        <form id="formData">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group mb-3 clearfix">
                                    <label class="form-label" for="data_country">Country <strong class="text-danger fw-bolder">*</strong></label>
                                    <select name="data_country" id="data_country" class="form-select rounded-0 select2 select2bs5" required>
                                ...
                                <table class="table table-striped table-hover" id="dataTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="align-middle text-center bg-secondary-subtle">Country Name</th>
