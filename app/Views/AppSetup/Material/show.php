                            ...
                            <div class="card-body">
                                <div class="row g-2">
                                    ...
                                    <div class="form-group col-xl-3 col-lg-3 col-md-6 col-sm-12 clearfix">
                                        ...
                                        <input type="text" name="data_code" id="data_code" class="form-control rounded-0" required placeholder="Material Code" maxlength="150" autocomplete="off" value="<?= $material['code'] ?>" disabled>
                                        <div class="invalid-feedback"></div>
                                    </div>
                                    <div class="form-group col-xl-3 col-lg-3 col-md-6 col-sm-12 clearfix">
                                        <label class="form-label" for="data_name">Material Name <strong class="text-danger fw-bolder">*</strong></label>
                                        <input type="text" name="data_name" id="data_name" class="form-control rounded-0" required placeholder="Material Name" maxlength="150" autocomplete="off" value="<?= $material['name'] ?>" disabled>
                                        <div class="invalid-feedback"></div>
                                    </div>
                                    <div class="form-group col-xl-4 col-lg-4 col-md-6 col-sm-12 clearfix">
                                        ...
                                        <input type="text" name="data_specification" id="data_specification" maxlength="255" class="form-control rounded-0" required placeholder="Material Specification" autocomplete="off" value="<?= $material['specification'] ?>" disabled>
                                        <div class="invalid-feedback"></div>
                                    </div>
                                    <div class="form-group col-xl-3 col-lg-3 col-md-6 col-sm-12 clearfix">
                                        <label class="form-label" for="data_cust_part_no">Customer Part No.</label>
                                        <input type="text" name="data_cust_part_no" id="data_cust_part_no" class="form-control rounded-0" placeholder="Customer Part No." maxlength="255" autocomplete="off" value="<?= $material['cust_part_no'] ?>" disabled>
                                    </div>
                                    <div class="form-group col-xl-3 col-lg-3 col-md-6 col-sm-12 clearfix">
                                        <label class="form-label" for="data_cust_part_name">Customer Part Name</label>
                                        <input type="text" name="data_cust_part_name" id="data_cust_part_name" class="form-control rounded-0" placeholder="Customer Part Name" maxlength="255" autocomplete="off" value="<?= $material['cust_part_name'] ?>" disabled>
                                    </div>
                                    <div class="form-group col-xl-2 col-lg-2 col-md-6 col-sm-12 clearfix">
                                        <label class="form-label" for="data_color">Material Color</label>
                                        <input type="text" name="data_color" id="data_color" class="form-control rounded-0" placeholder="Material Color" maxlength="50" autocomplete="off" value="<?= $material['color'] ?>" disabled>
                                    </div>
                                    <div class="form-group col-xl-2 col-lg-2 col-md-6 col-sm-12 clearfix">
                                    ...
                                    <div class="form-group col-xl-2 col-lg-2 col-md-6 col-sm-12 clearfix">
                                        ...
                                        <select name="data_property" id="data_property" class="form-control select2 select2bs5" required disabled>
                                    ...
                                    <div class="form-group col-xl-1 col-lg-1 col-md-6 col-sm-12 clearfix">
                                        ...
                                        <select name="data_uom" id="data_uom" class="form-control select2 select2bs5" required disabled>
                                            <option value="">-- Choose --</option>
                                    ...
                                    <div class="form-group col-xl-1 col-lg-1 col-md-6 col-sm-12 clearfix">
                                        ...
                                        <input type="number" step="1" name="data_shift_capacity" id="data_shift_capacity" class="form-control rounded-0" placeholder="Shift Capacity" autocomplete="off" value="<?= $material['shift_capacity'] ?>" disabled>
                                    </div>
                                    <div class="form-group col-xl-1 col-lg-1 col-md-6 col-sm-12 clearfix">
                                        <label class="form-label" for="data_spq">SPQ</label>
                                        <input type="number" step="1" name="data_spq" id="data_spq" class="form-control rounded-0" placeholder="Shift Capacity" autocomplete="off" value="<?= $material['spq'] ?>" disabled>
                                    </div>
                                    <div class="form-group col-xl-1 col-lg-1 col-md-6 col-sm-12 clearfix">
                                        <label class="form-label" for="data_qty_per_bag">Qty/Bag</label>
                                        <input type="number" step="1" name="data_qty_per_bag" id="data_qty_per_bag" class="form-control rounded-0" placeholder="Qty/Bag" autocomplete="off" value="<?= $material['qty_per_bag'] ?>" disabled>
                                    </div>
                                    <div class="form-group col-xl-1 col-lg-1 col-md-6 col-sm-12 clearfix">
                                        <label class="form-label" for="data_net_weight">Net Weight</label>
                                        <input type="number" step="0.01" name="data_net_weight" id="data_net_weight" class="form-control rounded-0" placeholder="Net Weight" autocomplete="off" value="<?= $material['net_weight'] ?>" disabled>
                                    </div>
                                    <div class="form-group col-xl-1 col-lg-1 col-md-6 col-sm-12 clearfix">
                                        <label class="form-label" for="data_gross_weight">Gross Weight</label>
                                        <input type="number" step="0.01" name="data_gross_weight" id="data_gross_weight" class="form-control rounded-0" placeholder="Gross Weight" autocomplete="off" value="<?= $material['gross_weight'] ?>" disabled>
                                    </div>
                                    <div class="form-group col-xl-1 col-lg-1 col-md-6 col-sm-12 clearfix">
                                        <label class="form-label" for="data_cavity">Cavity</label>
                                        <input type="number" step="0.01" name="data_cavity" id="data_cavity" class="form-control rounded-0" placeholder="Cavity" autocomplete="off" value="<?= $material['cavity'] ?>" disabled>
                                    </div>
                ...
                <div class="col-12">
                    <div class="card rounded-0">
                        <div class="card-body rounded-0">
                            <img src="<?= base_url() . 'uploads/material/' . $material['image'] ?>" class="img img-thumbnail img-size-64" alt="<?= $material['code'] ?>">
                        </div>
                    </div>
                </div>
            </div>
