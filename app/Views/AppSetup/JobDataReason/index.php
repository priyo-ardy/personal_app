            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-end">
                        ...
                        <li class="breadcrumb-item">Job Data Setup</li>
        ...
        <div class="container-fluid">
            <div class="row g-2">
                    ...
                    <div class="card rounded-0">
                        <form id="formData">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group mb-3 clearfix">
                                    <label class="form-label" for="data_action">Job Data Action <strong class="text-danger">*</strong></label>
                                    <select name="data_action" id="data_action" class="form-select rounded-0 select2 select2bs5" required>
                ...
                <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 clearfix">
                    <div class="card rounded-0">
                        <div class="card-header rounded-0">
                            <h3 class="card-title"><i class="bi bi-list-ul me-2"></i>Job Data Action List</h3>
                                ...
                                <table class="table table-striped table-hover" id="dataTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="align-middle text-center bg-secondary-subtle">Job Data Action</th>
