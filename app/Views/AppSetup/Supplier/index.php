                                ...
                                <table class="table table-striped table-hover table-bordered" id="dataTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="align-middle text-center bg-secondary-subtle">Supplier Code</th>
                                            <th class="align-middle text-center bg-secondary-subtle">Supplier Name</th>
                                            ...
                                            <th class="align-middle text-center bg-secondary-subtle">NPWP No</th>
                                            <th class="align-middle text-center bg-secondary-subtle">Bank Name</th>
                                            <th class="align-middle text-center bg-secondary-subtle">Bank Account No</th>
                                            <th class="align-middle text-center bg-secondary-subtle">Bank Account Name</th>
