            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-end">
                        ...
                        <li class="breadcrumb-item active">Absence Status Setup</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <div class="row g-2">
                        ...
                        <form id="formData">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group clearfix">
                                    ...
                                    <input type="text" name="data_code" id="data_code" class="form-control rounded-0" required maxlength="10" placeholder="Absence Status Code" autofocus autocomplete="off">
                                    <div class="invalid-feedback"></div>
                                </div>
                                <div class="form-group clearfix">
                                    <label class="form-label" for="data_name">Name <strong class="text-danger">*</strong></label>
                                    <input type="text" name="data_name" id="data_name" class="form-control rounded-0" required maxlength="150" placeholder="Absence Status Name" autocomplete="off">
                                    <div class="invalid-feedback"></div>
                                </div>
                                <div class="form-group clearfix">
                ...
                <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 clearfix">
                    <div class="card rounded-0">
                        <div class="card-header rounded-0">
                            <h3 class="card-title"><i class="bi bi-list-ul me-2"></i>Absence Status List</h3>
