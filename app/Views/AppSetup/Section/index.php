                    ...
                    <div class="card rounded-0">
                        <form id="formData">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group mb-3 clearfix">
                                    <label class="form-label" for="data_dept">Department<strong class="text-danger fw-bolder me-2">*</strong></label>
                                    <select name="data_dept" id="data_dept" class="form-select select2 select2bs5 rounded-0" required>
                                ...
                                <div class="form-group mb-3 clearfix">
                                    <label class="form-label" for="effective_date">Effective Date<strong class="text-danger fw-bolder me-2">*</strong></label>
