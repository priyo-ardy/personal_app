                            ...
                            <div class="card-body">
                                <div class="row g-2">
                                    ...
                                    <div class="form-group col-xl-2 col-lg-2 col-md-6 col-sm-12 mb-3 clearfix">
                                        ...
                                        <input type="text" name="data-code" id="data_code" class="form-control rounded-0" required placeholder="Machine No." maxlength="20">
                                        <div class="invalid-feedback"></div>
                                    </div>
                                    <div class="form-group col-xl-3 col-lg-3 col-md-6 col-sm-12 mb-3 clearfix">
                                        ...
                                        <input type="text" name="data_name" id="data_name" class="form-control rounded-0" required placeholder="Machine Name" maxlength="150">
                                        <div class="invalid-feedback"></div>
                                    </div>
                                    <div class="form-group col-xl-3 col-lg-3 col-md-6 col-sm-12 mb-3 clearfix">
                                        <label class="form-label" for="data_spesifikasi">Specification</label>
                                        <input type="text" name="data_spesifikasi" id="data_spesifikasi" class="form-control rounded-0" required placeholder="Machine Specification">
                                    </div>
                                    <div class="form-group col-xl-2 col-lg-2 col-md-6 col-sm-12 mb-3 clearfix">
                                        <label class="form-label" for="data_brand">Brand</label>
                                        <input type="text" name="data_brand" id="data_brand" class="form-control rounded-0" required placeholder="Machine Brand" maxlength="150">
                                    </div>
                                    <div class="form-group col-xl-3 col-lg-3 col-md-6 col-sm-12 mb-3 clearfix">
                                        <label class="form-label" for="serial_no">Serial No</label>
                                        <input type="text" name="serial_no" id="serial_no" class="form-control rounded-0" required placeholder="Serial No" maxlength="50">
                                    </div>
                                    <div class="form-group col-xl-2 col-lg-2 col-md-6 col-sm-12 mb-3 clearfix">
                                        <label class="form-label" for="data_tonnage">Tonnage</label>
                                        <select name="data_tonnage" id="data_tonnage" class="form-control select2 select2bs5">
                                            <option value="">-- Choose --</option>
                                    ...
                                    <div class="form-group col-xl-3 col-lg-3 col-md-6 col-sm-12 mb-3 clearfix">
                                        ...
                                        <input type="text" name="data_rate" id="data_rate" class="form-control rounded-0" required placeholder="Machine Rate" maxlength="20">
                                    </div>
                                    <div class="form-group col-xl-2 col-lg-2 col-md-6 col-sm-12 mb-3 clearfix">
                                        <label class="form-label" for="mfg_date">Mfg. Date</label>
                                        <input type="date" name="mfg_date" id="mfg_date" class="form-control rounded-0">
                                    </div>
                                    <div class="form-group col-xl-2 col-lg-2 col-md-6 col-sm-12 mb-3 clearfix">
                                        <label class="form-label" for="purchase_date">Purchase Date</label>
                                        <input type="date" name="purchase_date" id="purchase_date" class="form-control rounded-0">
                                    </div>
