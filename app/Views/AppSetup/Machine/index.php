            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-end">
                        ...
                        <li class="breadcrumb-item active">List of Machine</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <table class="table table-striped table-hover" id="dataTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="align-middle text-center bg-secondary-subtle">Machine No</th>
                                            <th class="align-middle text-center bg-secondary-subtle">Machine Name</th>
                                            ...
                                            <th class="align-middle text-center bg-secondary-subtle">Brand</th>
                                            <th class="align-middle text-center bg-secondary-subtle">Serial No</th>
                                            <th class="align-middle text-center bg-secondary-subtle">Tonnage</th>
                                            <th class="align-middle text-center bg-secondary-subtle">Rate</th>
                                            <th class="align-middle text-center bg-secondary-subtle">Mfg Date</th>
                                            <th class="align-middle text-center bg-secondary-subtle">Purchase Date</th>
