        ...
        <div class="container-fluid">
            <div class="row g-2">
                    ...
                    <div class="card rounded-0">
                        <form id="formData">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group mb-3 clearfix">
                                    <label class="form-label" for="data_debugging">Material Debugging Qty <strong class="text-danger fw-bolder">*</strong></label>
                                    <input type="number" name="data_debugging" id="data_debugging" class="form-control rounded-0" placeholder="Enter material debugging qty" required autocomplete="off">
                                </div>
                ...
                <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 clearfix">
                    <div class="card rounded-0">
                        <div class="card-header rounded-0">
                            <h3 class="card-title"><i class="bi bi-list-ul me-2"></i>Machine Tonnage List</h3>
                                ...
                                <table class="table table-striped table-hover" id="dataTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="align-middle text-center bg-secondary-subtle">Debugging Qty</th>
