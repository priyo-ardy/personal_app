            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-end">
                        ...
                        <li class="breadcrumb-item active">Special Leave Setup</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <div class="row g-2">
                    ...
                    <div class="card rounded-0">
                        <form id="formData">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group mb-3 clearfix">
                                    <label class="form-label" for="data_name">Name<strong class="text-danger fw-bolder me-2">*</strong></label>
                                ...
                                <div class="form-group mb-3 clearfix">
                                    <label class="form-label" for="data_hari">Leave Granted (days)<strong class="text-danger fw-bolder me-2">*</strong></label>
                                    <input type="number" name="data_hari" id="data_hari" class="form-control rounded-0" required placeholder="Leave Granted">
                                    <div class="invalid-feedback"></div>
                                </div>
                                <div class="form-group mb-3 clearfix">
                                    <label class="form-label" for="data_dokumen">Supporting Document<strong class="text-danger fw-bolder me-2">*</strong></label>
                                    <input type="text" name="data_dokumen" id="data_dokumen" class="form-control rounded-0" required placeholder="Supporting Document">
                                    <div class="invalid-feedback"></div>
                                </div>
                                <div class="form-group mb-3 clearfix">
                                    <label class="form-label" for="data_upload_dokumen">Supporting Document<strong class="text-danger fw-bolder me-2">*</strong></label>
                                    <select name="data_upload_dokumen" id="data_upload_dokumen" class="form-select select2 select2bs5 rounded-0" required>
                ...
                <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 clearfix">
                    <div class="card rounded-0">
                        <div class="card-header rounded-0">
                            <h3 class="card-title"><i class="bi bi-list-ul me-2"></i>Department List</h3>
                                ...
                                <table class="table table-striped table-hover" id="dataTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="align-middle text-center bg-secondary-subtle">Leave Granted</th>
                                            <th class="align-middle text-center bg-secondary-subtle">Supporting Document</th>
                                            <th class="align-middle text-center bg-secondary-subtle">Need Document Upload</th>
