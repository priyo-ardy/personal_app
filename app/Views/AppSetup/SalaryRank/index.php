            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-end">
                        ...
                        <li class="breadcrumb-item active">Salary Rank</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="card rounded-0">
                        <form id="formData">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group mb-3 clearfix">
                                    <label class="form-label" for="effective_date">Effective Date<strong class="text-danger fw-bolder">*</strong></label>
                                    <input type="date" name="effective_date" id="effective_date" class="form-control rounded-0" required>
                                    <div class="invalid-feedback"></div>
                                </div>
                                <div class="form-group mb-3 clearfix">
                                    <label class="form-label" for="data_salary">Salary Range <strong class="text-danger fw-bolder me-2">*</strong></label>
                                    <div class="row g-2">
                                        <div class="col-6">
                                            <input type="number" name="data_salary_from" id="data_salary_from" class="form-control rounded-0" placeholder="From" required value="0">
                                            <div class="invalid-feedback"></div>
                                        </div>
                                        <div class="col-6">
                                            <input type="number" name="data_salary_to" id="data_salary_to" class="form-control rounded-0" placeholder="To" required value="0">
                                            <div class="invalid-feedback"></div>
                                        </div>
                                    </div>
                                </div>
