            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-end">
                        ...
                        <li class="breadcrumb-item active">Overtime Setup</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <div class="row g-2">
                    ...
                    <div class="card rounded-0">
                        <form id="formData">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group mb-3 clearfix">
                                    <label class="form-label" for="data_type">Type of Working Hour <strong class="text-danger">*</strong></label>
                                    <select name="data_type" id="data_type" class="form-select rounded-0 select2 select2bs5" required>
                                        <option value="">-- Choose --</option>
                                        <option value="0">Work Day</option>
                                        <option value="1">Holiday (Office)</option>
                                        <option value="2">Holiday (Off)</option>
                                    </select>
                                    <div class="invalid-feedback"></div>
                                </div>
                                <div class="form-group mb-3 clearfix">
                                    <label class="form-label" for="data_rate">Rate Row <strong class="text-danger">*</strong></label>
                                    <input type="number" name="data_rate" id="data_rate" class="form-control rounded-0" placeholder="Enter rate" required>
                                    <div class="invalid-feedback"></div>
                                </div>
                ...
                <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 clearfix">
                    <div class="card rounded-0">
                        <div class="card-header rounded-0">
                            <h3 class="card-title"><i class="bi bi-list-ul me-2"></i>Overtime Setup List</h3>
...
<?= $this->include('AppSetup/OvertimeSetup/modal.php') ?>
<?= $this->endSection(); ?>