                    ...
                    <div class="card rounded-0">
                        <form id="formData">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group mb-3 clearfix">
                                    <label class="form-label" for="data_province">Province <strong class="text-danger fw-bolder">*</strong></label>
                                    <select name="data_province" id="data_province" class="form-select rounded-0 select2 select2bs5" required>
                                ...
                                <table class="table table-striped table-hover" id="dataTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="align-middle text-center bg-secondary-subtle">Province Name</th>
                                            <th class="align-middle text-center bg-secondary-subtle">City Name</th>
