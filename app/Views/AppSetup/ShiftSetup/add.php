                        ...
                        <div class="card-body">
                            <div class="row g-2">
                                ...
                                <div class="form-group col-xl-2 col-lg-2 col-md-6 col-sm-12 clearfix">
                                    ...
                                    <select name="working_day" id="working_day" class="form-control select2 select2bs5">
                            ...
                            <div id="form-auto-lembur" hidden>
                                <div class="row g-2 mb-3">
                                    ...
                                    <div class="form-group col-xl-2 col-lg-2 col-md-6 col-sm-12 clearfix">
                                        ...
                                        <input type="number" name="lama_lembur" id="lama_lembur" class="form-control rounded-0" placeholder="Overtime duration">
                                        <div class="invalid-feedback"></div>
                                    </div>
                                    <div class="form-group col-xl-2 col-lg-2 col-md-6 col-sm-12 clearfix">
                                        <label class="col-form-label">Overtime break length</label>
                                        <input type="number" name="lama_istirahat" id="lama_istirahat" class="form-control rounded-0" placeholder="Overtime break length">
                                        <div class="invalid-feedback"></div>
                                    </div>
                                </div>
                                <div class="row g-2 mb-3">
                                    <div class="form-group col-xl-2 col-lg-2 col-md-6 col-sm-12 clearfix">
                                        ...
                                        <input type="number" name="rate_lembur" id="rate_lembur" class="form-control rounded-0" placeholder="00.00" maxlenght="5">
                                        <div class="invalid-feedback"></div>
                                    </div>
                                    <div class="form-group col-xl-2 col-lg-2 col-md-6 col-sm-12 clearfix">
                                        <label class="col-form-label">x15</label>
                                        <input type="number" name="lembur_x15" id="lembur_x15" class="form-control rounded-0" placeholder="00.00" maxlenght="5">
                                        <div class="invalid-feedback"></div>
                                    </div>
                                    <div class="form-group col-xl-2 col-lg-2 col-md-6 col-sm-12 clearfix">
                                        <label class="col-form-label">x20</label>
                                        <input type="number" name="lembur_x20" id="lembur_x20" class="form-control rounded-0" placeholder="00.00" maxlenght="5">
                                        <div class="invalid-feedback"></div>
                                    </div>
                                    <div class="form-group col-xl-2 col-lg-2 col-md-6 col-sm-12 clearfix">
                                        <label class="col-form-label">x30</label>
                                        <input type="number" name="lembur_x30" id="lembur_x30" class="form-control rounded-0" placeholder="00.00" maxlenght="5">
                                        <div class="invalid-feedback"></div>
                                    </div>
                                    <div class="form-group col-xl-2 col-lg-2 col-md-6 col-sm-12 clearfix">
                                        <label class="col-form-label">x40</label>
                                        <input type="number" name="lembur_x40" id="lembur_x40" class="form-control rounded-0" placeholder="00.00" maxlenght="5">
                                        <div class="invalid-feedback"></div>
                                    </div>
                                </div>
                            </div>
