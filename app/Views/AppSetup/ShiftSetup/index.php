                                ...
                                <table class="table table-striped table-hover table-bordered" id="dataTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="align-middle text-center bg-secondary-subtle">Shift Code</th>
                                            <th class="align-middle text-center bg-secondary-subtle">Shift Name</th>
                                            <th class="align-middle text-center bg-secondary-subtle">Working Day</th>
                                            <th class="align-middle text-center bg-secondary-subtle">Std. Clock In</th>
                                            <th class="align-middle text-center bg-secondary-subtle">Std. Clock Out</th>
                                            <th class="align-middle text-center bg-secondary-subtle">Break</th>
                                            <th class="align-middle text-center bg-secondary-subtle">Overday</th>
                                            <th class="align-middle text-center bg-secondary-subtle">Working Hour Type</th>
                                            <th class="align-middle text-center bg-secondary-subtle">Standart Working Hour</th>
                                            ...
                                            <th class="align-middle text-center bg-secondary-subtle">Index</th>
                                            <th class="align-middle text-center bg-secondary-subtle">Default Absence Status</th>
