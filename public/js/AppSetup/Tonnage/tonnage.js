window.onload = () => {
  loadTable("dataTable", "/tonnage/table");
...
const inputForm = {
  ...
  debugging: document.getElementById("data_debugging"),
...
buttons.delete.addEventListener("click", () => {
  ...
  if (!isAnyCheckboxChecked) {
    ...
    try {
      disableData("/tonnage/delete", selectedData);
    } catch (e) {
      pesanError(e.message);
    }
  }
...
buttons.export.addEventListener("click", async () => {
  try {
    ...
    const response = await fetch(baseurl + "/tonnage/export", {
      method: "GET",
    ...
    a.href = url;
    a.download =
      "machine_tonnage_list_" + moment().format("YYYYMMDD_HHMMSS") + ".xlsx";
